            ...
            <div class="row mb-5">
                    ...
                    <div class="row m-sm-0">
                        <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                            <div class="swiper product-slider-thumbs">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-auto swiper-thumb-item mb-3" style="background-color: white">
                                        <img class="w-100"
                                            src="
                        ...
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="swiper product-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-auto" style="background-color: white"><a
                                            class="glightbox product-view" href="img/product-detail-1.jpg"
                                            data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid"
                                                src="{{ asset('uploads/' . $product->image) }}" alt="..."></a></div>
                                    <div class="swiper-slide h-auto" style="background-color: white"><a
                                            class="glightbox product-view" href="img/product-detail-2.jpg"
                                            data-gallery="gallery2" data-glightbox="Product item 2"><img
                                                class="img-fluid" src="{{ asset('uploads/' . $product->image) }}"
                                                alt="..."></a></div>
                                    <div class="swiper-slide h-auto" style="background-color: white"><a
                                            class="glightbox product-view" href="img/product-detail-3.jpg"
                                            data-gallery="gallery2" data-glightbox="Product item 3"><img
                                                class="img-fluid" src="{{ asset('uploads/' . $product->image) }}"
                                                alt="..."></a></div>
                                    <div class="swiper-slide h-auto" style="background-color: white"><a
                                            class="glightbox product-view" href="img/product-detail-4.jpg"
                ...
                <div class="col-lg-6">
                            ...
                            <form method="post" action="{{ route('cart.store') }}">
                                ...
                                <div class="border d-flex align-items-center justify-content-between py-1 px-3 bg-white border-white">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <input class="form-control border-0 shadow-0 p-0" type="text" name="qty"
                                            value="1" readonly style="background: white">
                    ...
                    <ul class="list-unstyled small d-inline-block">
                        ...
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Total
                                Items : &nbsp; <span class="text text-danger"> {{ $product->ProductDetail->total_items }}
                                    Items Remaining </span></strong></li>
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
            ...
            <div class="tab-content mb-5" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="p-4 p-lg-5 bg-white">
                        ...
                        <p class="text-muted text-sm mb-0"> {{ $product->ProductDetail->description }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product text-center skel-loader">
                            <div class="d-block mb-3 position-relative">
                                <a class="d-block" href="{{ route('product.single', $related_product->id) }}">
                                    <img class="img-fluid w-100" src="{{ asset('uploads/' . $related_product->image) }}"
                                        alt="...">
                                </a>
                                    ...
                                    <ul class="mb-0 list-inline">
                                        ...
                                        <li class="list-inline-item m-0 p-0">
                                            <a class="btn btn-sm btn-dark"
                                                href="{{ route('product.single', $related_product->id) }}">Add to cart
                                            </a>
                                        </li>
