        ...
        <div class="dashboard-wrapper" >
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header"><b style="font-size: 25px">Admin Registration</b></h5>
                            <div class="card-body">
                                <form action="{{ route('admin.register') }}" method="post" class="needs-validation" novalidate>
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            id="validationCustom06" name="image" required>
                                                <span class="text-danger">
                                                    @error('image')
                                                    {{ $message }}
                                                    @enderror
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom09" name="country"
